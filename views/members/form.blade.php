...
<div class="two fields">
    <div class="field{{ $errors->has('meta.first_name') ? ' error' : '' }}">
    ...
    <div class="field{{ $errors->has('meta.last_name') ? ' error' : '' }}">
...
<div class="two fields">
    ...
    <div class="field{{ $errors->has('meta.title') ? ' error' : '' }}">
...
<div class="two fields">
    <div class="field{{ $errors->has('meta.home_phone') ? ' error' : '' }}">
    ...
    <div class="field{{ $errors->has('meta.work_phone') ? ' error' : '' }}">
